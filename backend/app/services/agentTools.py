from app.schemas.chartTypes import CHART_TYPE_VALUES, CHART_TYPE_GUIDANCE, MAP_GUIDANCE, ChartType


def build_tool_schemas(has_country: bool) -> list[dict]:
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "chart_type": {
                            ...
                            "enum": chart_type_values,
                            "description": (
                                "Must match the SQL output shape. See guidance below for how "
                                "to pick and how to configure each type:\n" + chart_type_guidance
                            ),
                        },
                        "sql": {
                            "type": "string",
